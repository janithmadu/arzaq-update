    ...
    <div className="">
      <div className="flex gap-y-[24px] flex-col">
        <div className="flex justify-between min-h-[56px]  min-w-full items-center">
          <div className="flex gap-x-[16px] items-center">
           {
            ...
            />
              ...
              <div className="rounded-full bg-grayscale200 w-12 h-12 flex justify-center items-center"><h1 className="text-bodyxl">{name[1]}</h1></div>
            )
           }
          ...
          <Link className="text-[#6f68a8] text-bodysmall"  href={`/${locale}/profile/${UserID}?page=1`}>
            {t("ViewProfile")}
          </Link>
        </div>
